    ...
    <div class="row">
        <div class="col-md-3">
            <div class="panel panel-success">
                ...
                <div class="panel-body text-center">
                    <p class="lead" style="font-size:40px"> &nbsp;<strong> ฿700 / <?= lang('year') ?> </strong></p>
                </div>
                <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item"><i class="fa fa-archive"></i> <?= lang('storage') ?> <del>1GB</del> <strong>3GB</strong></li>
                    <li class="list-group-item"><i class="fa fa-cloud-download"></i> <?= lang('bandwidth') ?> <del>10GB</del> <strong>20GB / <?= lang('month') ?></strong></li>
                    ...
                    <table width="100%">
                        <tr>
                            <td style="padding: 0px 4px;">
                                <a class="btn btn-block btn-danger" href="https://www.thaihubhosting.com/customer/cart.php?a=add&pid=5"><i class="fa fa-shopping-cart"></i> สั่งซื้อ</a>
                            </td>
                            <td style="padding: 0px 4px;">
        ...
        <div class="col-md-3">
            <div class="panel panel-warning">
                ...
                <div class="panel-body text-center">
                    <p class="lead" style="font-size:40px"><strong>฿1,500 / <?= lang('year') ?></strong></p>
                </div>
                <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item"><i class="fa fa-archive"></i> <?= lang('storage') ?> <del>3GB</del> <strong>5GB</strong></li>
                    <li class="list-group-item"><i class="fa fa-cloud-download"></i> <?= lang('bandwidth') ?> <del>20GB</del> <strong>40GB / <?= lang('month') ?></strong></li>
                    <li class="list-group-item"><i class="fa fa-cubes"></i> <?= lang('domain') ?> 1</li>
                ...
                <div class="panel-footer">
                    <table width="100%">
                        <tr>
                            <td style="padding: 0px 4px;">
                                <a class="btn btn-block btn-danger" href="https://www.thaihubhosting.com/customer/cart.php?a=add&pid=6"><i class="fa fa-shopping-cart"></i> สั่งซื้อ</a>
                            </td>
                            <td style="padding: 0px 4px;">
                                <?= anchor('hosting', '<i class="fa fa-info-circle"></i> เพิ่มเติม', array('class' => 'btn btn-block btn-danger')) ?>
                            </td>
        ...
        <div class="col-md-3">
            <div class="panel panel-danger">
                ...
                <div class="panel-body text-center">
                    <p class="lead" style="font-size:40px"><strong>฿2,700 / <?= lang('year') ?></strong></p>
                </div>
                <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item"><i class="fa fa-archive"></i> <?= lang('storage') ?> <del>6GB</del> <strong>7GB</strong></li>
                    <li class="list-group-item"><i class="fa fa-cloud-download"></i> <?= lang('bandwidth') ?> <del>40GB</del> <strong>150GB / <?= lang('month') ?></strong></li>
                    <li class="list-group-item"><i class="fa fa-cubes"></i> <?= lang('domain') ?> 2</li>
                    <li class="list-group-item"><i class="fa fa-check"></i> <?= lang('free_domain') ?> 1 <?= lang('year') ?></li>
                    <li class="list-group-item"><i class="fa fa-database"></i> Mysql Database 8</li>
                </ul>
                <div class="panel-footer">
                    <table width="100%">
                        <tr>
                            <td style="padding: 0px 4px;">
                                <a class="btn btn-block btn-danger" href="https://www.thaihubhosting.com/customer/cart.php?a=add&pid=7"><i class="fa fa-shopping-cart"></i> สั่งซื้อ</a>
                            </td>
                            <td style="padding: 0px 4px;">
                                <?= anchor('hosting', '<i class="fa fa-info-circle"></i> เพิ่มเติม', array('class' => 'btn btn-block btn-danger')) ?>
                            </td>
        ...
        <div class="col-md-3">
            <div class="panel panel-info">
                ...
                <div class="panel-body text-center">
                    <p class="lead" style="font-size:40px"><strong>฿5,500 / <?= lang('year') ?></strong></p>
                </div>
                <ul class="list-group list-group-flush text-center">
                    <li class="list-group-item"><i class="fa fa-archive"></i> <?= lang('storage') ?> <del>8GB</del> <strong>10GB</strong></li>
                    <li class="list-group-item"><i class="fa fa-cloud-download"></i> <?= lang('bandwidth') ?> <del>80GB</del> <strong>300GB / <?= lang('month') ?></strong></li>
                    <li class="list-group-item"><i class="fa fa-cubes"></i> <?= lang('domain') ?> 2</li>
                    <li class="list-group-item"><i class="fa fa-check"></i> <?= lang('free_domain') ?> 1 <?= lang('year') ?></li>
                    <li class="list-group-item"><i class="fa fa-database"></i> Mysql Database 16</li>
                </ul>
                <div class="panel-footer">
                    <table width="100%">
                        <tr>
                            <td style="padding: 0px 4px;">
                                <a class="btn btn-block btn-danger" href="https://www.thaihubhosting.com/customer/cart.php?a=add&pid=8"><i class="fa fa-shopping-cart"></i> สั่งซื้อ</a>
                            </td>
                            <td style="padding: 0px 4px;">
                                <?= anchor('hosting', '<i class="fa fa-info-circle"></i> เพิ่มเติม', array('class' => 'btn btn-block btn-danger')) ?>
                            </td>
